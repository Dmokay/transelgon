...
<div class="main-content">
    ...
    <section class="full-height-slider type-1">
       <div class="bg ready data-jarallax" data-jarallax="5" style="background-image: url(img/contacts/main-baner-bg.jpg)" data-swiper-parallax="50%"></div>
                ...
                <div class="empty-sm-30"></div>
                 <div class="col-md-10 col-md-offset-1">
                   <div class="simple-text md">
                       ...
                       <p>You can always reach out to us on the contact info below.</p>
                ...
                <div class="row">
                  ...
                  <div class="empty-sm-15 empty-xs-10"></div>
                    <h4 class="h4 tt color-type-3">Call us</h4>
                     ...
                     <div class="simple-text contact color-2">
                       <a href="tel:3805623157851" class="link-hover">+254743139295 / +254712935408.</a>
                     </div>
                  </div>
                  </div>
                  <div class="col-sm-4 col-xs-12">
                  ...
                  <h4 class="h4 tt color-type-3">FIND us</h4>
                     ...
                     <div class="simple-text color-2 contact">
                       <p>Kapsokwony Town, Mt Elgon, Bungoma County.</p>
                     </div>
                  </div>
                  </div>
                  <div class="col-sm-4 col-xs-12">
                  ...
                  <div class="empty-sm-15 empty-xs-10"></div>
                    <h4 class="h4 tt color-type-3">MAIL us</h4>
                     <div class="empty-sm-20 empty-xs-10"></div>
                     <div class="simple-text contact color-2">
                       <a href="mailto:delice.info@mail.com" class="link-hover">transelgonmillers@gmail.com</a>
                     </div>
                  </div>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="main-caption text-center color-type-2">
            ...
            <p>We have a team dedicated to handling your queries round the clock</p>
            </div>
          </div>
          </div>
        </div>
              ...
              <div class="text-center color-type-2">
                <h4 class="h4 tt color-type-1">working time</h4>
                 ...
                 <div class="simple-text">
                   <p>We are open for work through the week as per the times below</p>
                 </div>
                 <div class="empty-sm-20 empty-xs-10"></div>
    ...
    <!-- <section class="section">
      ...
      <div class="container">
        <div class="row">
          <div class="text-center color-type-2">
            <h4 class="h4 tt color-type-1">Join Us On Instagram</h4>
          </div>
          <div class="empty-sm-25 empty-xs-20"></div>
          <div class="col-md-12 col-xs-12">
            <div class="contact-instagram no-padd no-padd-sm">
              <div class="row">
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <a href="#"><img src="img/contacts/insta-1.jpg" alt="" class="full-img"></a>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <a href="#"><img src="img/contacts/insta-2.jpg" alt="" class="full-img"></a>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <a href="#"><img src="img/contacts/insta-3.jpg" alt="" class="full-img"></a>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <a href="#"><img src="img/contacts/insta-4.jpg" alt="" class="full-img"></a>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <a href="#"><img src="img/contacts/insta-5.jpg" alt="" class="full-img"></a>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <a href="#"><img src="img/contacts/insta-6.jpg" alt="" class="full-img"></a>
                </div>
              </div>
            </div>
            <div class="empty-sm-25 empty-xs-20"></div>

    		...
    		<div class="table-view mobile-rel-block">
    			<div class="table-cell">
    			   <div class="container"> 
    				   <div class="row vertical-wrap">
    						<div class="col-sm-8 col-sm-offset-2 col-xs-12">
    						  ...
    						  <div class="main-title coming-title">
    						   <h1 class="h1 caption">Coming Soon</h1>
                  ...
                  <ul class="list-style-2 ul-list coming-address text-center">
                     <li><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 348.077 348.077" style="enable-background:new 0 0 348.077 348.077;" xml:space="preserve">
                          ...
                          <a href="tel:" class="link-hover"><b>Phone:</b> +254 712 935 408</a>
                     </li>
                      <li><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 80 80" style="enable-background:new 0 0 80 80;" xml:space="preserve" width="24px" height="24px">
                      <g><g><path d="M40,0C26.191,0,15,11.194,15,25c0,23.87,25,55,25,55s25-31.13,25-55C65,11.194,53.807,0,40,0z     M40,38.8c-7.457,0-13.5-6.044-13.5-13.5S32.543,11.8,40,11.8c7.455,0,13.5,6.044,13.5,13.5S47.455,38.8,40,38.8z" fill="#898989"></path>
                        ...
                        <span><b>Address:</b> Kapsokwony Town, Mt Elgon, Bungoma County.</span>
                     </li>
                     <li><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 511.626 511.627" style="enable-background:new 0 0 511.626 511.627;" xml:space="preserve">
                  ...
                  <form action="/" onsubmit="return subscribeForm();" method="post" id="subscribe-form" class="subscribe-form flex-align form-type-2 coming-subscribe">
    				...
    				<div class="copyright text-center coming">
    				   <div class="container">
                <div class="col-xs-12">

           ...
           <div class="row">
               <div class="col-md-3 col-sm-6 col-sm-12">
                   <div class="footer-item">
                       <img src="{{asset('img/tlogo.png')}}" alt="">
                       <div class="empty-sm-15 empty-xs-15"></div> 
                       <div class="simple-text">
                           <p>TransElgon millers ltd is a maize flour milling company.</p>
                       </div>
               ...
               <div class="col-md-3 col-sm-6 col-sm-12">
                 <div class="footer-item">   
                   ...
                   <ul class="list-style-2 ul-list">
                       <li>Kapsokwony Town, Mt Elgon, Bungoma County.</li>
                       <li><a href="tel:" class="link-hover">+254743139295 / +254712935408</a></li>
                       <li><a href="mailto:" class="link-hover">transelgonmillers@gmail.com</a></li>
                   </ul>
                </div>
                 <div class="empty-sm-30 empty-xs-30"></div>
               </div>

<header class="header header-style-1">
    <div class="navigation flex-align">
        <a href="{{url('/')}}" class="logo"><img src="{{asset('img/tlogo.png')}}" alt="Transelgon"><img
                src="{{asset('img/tlogo.png')}}" alt="Transelgon" class="logo-type-2"></a>
                ...
                <div class="right-block">
                    <div class="shop-card-item">
                        <div class="shop-icon">
                            ...
                            <div class="shop-number" id="s-count"></div>
                        </div>
                        <span class="shop-card-price">Total: <b class="main-col elm-total"></b></span>
                        <div class="shop-card-list">
                            <div class="shop-card-align-mobile">
                                ...
                                <div class="buy-bar">
                                    <div class="fl">
                                        <h4 class="h4 caption">Total:<b class="main-col elm-total"></b></h4>
                                    </div>
                                    <div class="fr">
                                        <a href="{{route('checkout')}}" class="page-button button-style-1 type-4"><span
                                                class="txt">go to checkout</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="follow">
                        <a href="{{url('https://web.facebook.com/people/TransElgon-Millers-Ltd/100086998458173/')}}"
                           target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 version="1.1" x="0px" y="0px" viewBox="0 0 155.139 155.139"
                                 style="enable-background:new 0 0 155.139 155.139;" xml:space="preserve" width="16px"
                                 height="16px"><g>
                                    <path
                        ...
                        <a href="{{url('https://twitter.com/transelgonmill')}}" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 version="1.1" x="0px" y="0px" viewBox="0 0 310 310"
        ...
        function removeItem(id){
            ...
            if (cart !== null) {
                ...
                if (index === -1)
                    ...
                    cart.splice(index, 1)
                    //delete cart[Object.keys(cart)[index]]
                }
            }
        ...
        function cart() {
            ...
            if (cart !== null){
                ...
                cart.forEach(function(item){
                    ...
                    cart_div.append("<li class='flex-align'>"+
                        "<div class='img hover-zoom'>"+
                        "<a href='checkout-1.html#'><img src='"+ item.image +"' alt=''></a>"+
                        "</div>"+
                        "<h5 class='h5 caption'><a href='#' class='link-hover'>"+ item.name + "-"+ item.type + "("+ item.size +" KG)" +"</a></h5>"+
                        "<div class='shop-counter'><div class='custom-input-number'>"+
                        "<input type='number' class='cin-input disabled input-field' step='1' value='"+ item.quantity +"' min='0' max='1000'>"+
                        "</div></div>"+
                        "<div class='menu-price main-col'> KES: "+ item_total+"</div>"+
                        "<div onclick='removeItem("+ item.id +")' class=\"close-item main-fill-hover\">"+
                ...
                $('.elm-total').append("KES: "+total_price)
            }
        }
    </script>
@endsection

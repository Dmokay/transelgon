           ...
           <div class="nav">
            ...
            <nav>
              <ul class="header-menu">
                    ...
                    <li><a href="shop-1.html">Shop<img src="img/down-arrow.png" alt="" class="menu-arr"></a></li>
					<li><a href="contact-1.html">Contact<img src="img/down-arrow.png" alt="" class="menu-arr"></a></li>
                </ul>
            </nav>
            </div>
           </div>    

...
<body class="page-color-style-1 page-style-1">
    ...
    <div class="color-piker">
	 ...
	 viewBox="0 0 478.703 478.703" style="enable-background:new 0 0 478.703 478.703;" xml:space="preserve" width="24px" height="24px">
        ...
        <div class="color-wrapper">
          ...
          <input value="f4a01b" class="jscolor" onchange="updateScheme(this.jscolor)" id="jscolorid" />
        </div>
    ...
    <!--market-->
    <a href="https://themeforest.net/item/delice-power-multi-purpose-food-restaurant-ecommerce-html-template/20435172?ref=unionagency&license=regular&open_purchase_for_item_id=20435172&purchasable=source/" class="pulse-wr">
           ...
           <div class="nav">
            ...
            <nav>
              <ul class="header-menu">
                <li class="active"><a href="home_1.html">Home<img src="img/down-arrow.png" alt="" class="menu-arr"></a>
                        <ul>
                    ...
                    <li><a href="shop-1.html">Shop<img src="img/down-arrow.png" alt="" class="menu-arr"></a>
                        <ul>
